...
import './UstHeaderComp.css'

function UstHeaderComp() {
        ...
        <header className="fixed w-full bg-gradient-to-r from-indigo-600 to-purple-700 shadow-xl font-sans z-50">
            <div className="container mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center">
                    ...
                    >
                        Teacher's <span className="text-yellow-300">Panel</span>
                    </a>
                </div>
                ...
                <nav className=" hidden md:flex space-x-4 lg:space-x-6 items-center">
                    ...
                    <NavItem 
                        ...
                        text="All Students"
                        onClick={() => navigateTo('/all-students')}
                    />
